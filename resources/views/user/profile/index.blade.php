    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{{ '@' . $user->firstname }}'s Profile</div>

                <div class="panel-body">
                    <img src="{{ Config::get('s3.buckets.images') . '/avatars/' . ($user->hasCustomAvatar() ?  $user->avatar : 'avatar-blank.png') }}" class="img-thumbnail pull-left" width="100" height="100" alt="{{ $user->firstname }}-avatar">
                    @if (Auth::check() && Auth::user()->id === $user->id)
                        <a href="{{ route('user.profile.settings.index', Auth::user()->firstname) }}" class="pull-right"><span class="glyphicon glyphicon-pencil"></span></a>
                    @endif
