                                            ...
                                            <section class="list-left">
                                                ...
                                                <div style="margin-top:20px; ">
                                                    ...
                                                    @endif
                                                        ...
                                                        <a class="btn btn-warning pull-right" style="margin-right: 5px; width:70px;height: 50px;" href="{{ route('user.chat.threads.thread.messages.index', $advertisment->user_id) }}">Contact</a>
