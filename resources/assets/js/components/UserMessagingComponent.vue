    ...
    export default {
        ...
        methods: {
            getMessages() {
                ...
                return this.$http.get('/user/chat/threads/@' + this.data_recipient.firstname + '/messages/fetch').then((response) => {
            ...
            send() {
                ...
                return this.$http.post('/user/chat/threads/@' + this.data_recipient.firstname + '/messages', {
                    content: this.messageInput
                }).then((response) => {
